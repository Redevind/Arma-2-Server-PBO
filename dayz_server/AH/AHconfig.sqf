/*
	...
	You need to have your server updated to the latest Arma2OA beta
	http://p.infiSTAR.de/02-07-15_09-58-31.png
	
	If you don't know how to do that, a simple way is to update your client
	and then just copy paste the .exe files on your server.
...
/* *********************************www.infiSTAR.de********************************* */
/* *****************Survival Servers Version 6.1.0 - July 17, 2015****************** */
/* ********************************************************************************* */
...
[
	...
	"s_player2473_copyToKey","SP_refuel_action","SP_repair_action","SP_rearm_actions","s_player_setVectorsReset","s_player_setVectorsForward",
